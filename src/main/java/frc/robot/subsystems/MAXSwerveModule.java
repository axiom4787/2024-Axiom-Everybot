...
public class MAXSwerveModule extends SubsystemBase {
        ...
        public void setDesiredState(SwerveModuleState desiredState) {
                ...
                SmartDashboard.putNumber("Module " + (this.m_turningSparkMax.getDeviceId()) + " Calculated Drive Speed",
                                optimizedDesiredState.speedMetersPerSecond);
                SmartDashboard.putNumber("Module " + (this.m_turningSparkMax.getDeviceId()) + " Calculated Angle",
        ...
        public void periodic() {
                SmartDashboard.putNumber("Module " + (this.m_turningSparkMax.getDeviceId()) + " Encoder Position",
                                this.m_turningEncoder.getPosition());
        }
}